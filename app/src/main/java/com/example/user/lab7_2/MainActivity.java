...
public class MainActivity extends AppCompatActivity {
    ...
    protected TextView standardWeight,bobyFat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        standardWeight=(TextView)findViewById(R.id.standerdWeight);
        bobyFat=(TextView)findViewById(R.id.bobyFat);
    ...
    private void runAsyncTask(){
        new AsyncTask<Void,Integer,Boolean>(){
            ...
            protected void onPostExecute(Boolean status){
                ...
                double cal_BobyFat=0;
                if(gender==1){
                    cal_StandWeight=22*cal_Tall/100*cal_Tall/100;
                    cal_BobyFat=(cal_Weight-(0.88*cal_StandWeight))/cal_Weight*100;
                }
                if(gender==2){
                    cal_StandWeight=22*cal_Tall/100*cal_Tall/100;
                    cal_BobyFat=(cal_Weight-(0.82*cal_StandWeight))/cal_Weight*100;
                }
                standardWeight.setText(String.format("%.2f",cal_StandWeight));
                bobyFat.setText(String.format("%.2f",cal_BobyFat));
            }
        }.execute();
    }
}
